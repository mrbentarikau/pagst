...
var RSVPSessionTableColumns = struct {
	MessageID       string
	GuildID         string
	ChannelID       string
	LocalID         string
	...
	MessageID:       "rsvp_sessions.message_id",
	GuildID:         "rsvp_sessions.guild_id",
	ChannelID:       "rsvp_sessions.channel_id",
	LocalID:         "rsvp_sessions.local_id",
	AuthorID:        "rsvp_sessions.author_id",
	CreatedAt:       "rsvp_sessions.created_at",
	StartsAt:        "rsvp_sessions.starts_at",
	Title:           "rsvp_sessions.title",
	Description:     "rsvp_sessions.description",
	MaxParticipants: "rsvp_sessions.max_participants",
	SendReminders:   "rsvp_sessions.send_reminders",
	SentReminders:   "rsvp_sessions.sent_reminders",
}
...
func (r *rsvpSessionR) GetRSVPSessionsMessageRSVPParticipants() RSVPParticipantSlice {
	if r == nil {
		return nil
	}
	return r.RSVPSessionsMessageRSVPParticipants
}
...
var (
	...
	rsvpSessionGeneratedColumns      = []string{}
)

type (
	// RSVPSessionSlice is an alias for a slice of pointers to RSVPSession.
	// This should almost always be used instead of []RSVPSession.
...
// CountG returns the count of all RSVPSession records in the query using the global executor
...
func (o *RSVPSession) RSVPSessionsMessageRSVPParticipants(mods ...qm.QueryMod) rsvpParticipantQuery {
	...
	return RSVPParticipants(queryMods...)
}
...
func RSVPSessions(mods ...qm.QueryMod) rsvpSessionQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"rsvp_sessions\".*"})
	}

	return rsvpSessionQuery{q}
}
