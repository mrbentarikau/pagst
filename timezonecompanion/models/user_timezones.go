...
var UserTimezoneTableColumns = struct {
	UserID       string
	TimezoneName string
}{
	UserID:       "user_timezones.user_id",
	TimezoneName: "user_timezones.timezone_name",
}
...
var (
	...
	userTimezoneGeneratedColumns      = []string{}
)

type (
	// UserTimezoneSlice is an alias for a slice of pointers to UserTimezone.
	// This should almost always be used instead of []UserTimezone.
...
// CountG returns the count of all UserTimezone records in the query using the global executor
...
func UserTimezones(mods ...qm.QueryMod) userTimezoneQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"user_timezones\".*"})
	}

	return userTimezoneQuery{q}
}
