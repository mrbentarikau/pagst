...
var TwitterFeedTableColumns = struct {
	ID              string
	GuildID         string
	CreatedAt       string
	TwitterUsername string
	...
	ID:              "twitter_feeds.id",
	GuildID:         "twitter_feeds.guild_id",
	CreatedAt:       "twitter_feeds.created_at",
	TwitterUsername: "twitter_feeds.twitter_username",
	TwitterUserID:   "twitter_feeds.twitter_user_id",
	ChannelID:       "twitter_feeds.channel_id",
	Enabled:         "twitter_feeds.enabled",
	IncludeReplies:  "twitter_feeds.include_replies",
	IncludeRT:       "twitter_feeds.include_rt",
	MentionRole:     "twitter_feeds.mention_role",
}
...
var TwitterFeedWhere = struct {
	...
	MentionRole:     whereHelpertypes_Int64Array{field: "\"twitter_feeds\".\"mention_role\""},
}
...
var (
	twitterFeedAllColumns            = []string{"id", "guild_id", "created_at", "twitter_username", "twitter_user_id", "channel_id", "enabled", "include_replies", "include_rt", "mention_role"}
	twitterFeedColumnsWithoutDefault = []string{"guild_id", "created_at", "twitter_username", "twitter_user_id", "channel_id", "enabled"}
	twitterFeedColumnsWithDefault    = []string{"id", "include_replies", "include_rt", "mention_role"}
	twitterFeedPrimaryKeyColumns     = []string{"id"}
	twitterFeedGeneratedColumns      = []string{}
)

type (
	// TwitterFeedSlice is an alias for a slice of pointers to TwitterFeed.
	// This should almost always be used instead of []TwitterFeed.
...
// CountG returns the count of all TwitterFeed records in the query using the global executor
...
func TwitterFeeds(mods ...qm.QueryMod) twitterFeedQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"twitter_feeds\".*"})
	}

	return twitterFeedQuery{q}
}
