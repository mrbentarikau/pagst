...
const (
	...
	EventGuildScheduledEventCreate Event = 35
	EventGuildScheduledEventDelete Event = 36
	EventGuildScheduledEventUpdate Event = 37
	EventGuildScheduledEventUserAdd Event = 38
	EventGuildScheduledEventUserRemove Event = 39
	EventGuildStickersUpdate Event = 40
	EventGuildUpdate Event = 41
	EventIntegrationCreate Event = 42
	EventIntegrationDelete Event = 43
	EventIntegrationUpdate Event = 44
	EventInteractionCreate Event = 45
	EventInviteCreate Event = 46
	EventInviteDelete Event = 47
	...
	EventReady Event = 59
	EventResumed Event = 60
	EventStageInstanceCreate Event = 61
	EventStageInstanceDelete Event = 62
	EventStageInstanceEventCreate Event = 63
	EventStageInstanceEventDelete Event = 64
	EventStageInstanceEventUpdate Event = 65
	EventStageInstanceUpdate Event = 66
	EventThreadCreate Event = 67
	EventThreadDelete Event = 68
	EventThreadListSync Event = 69
	EventThreadMemberUpdate Event = 70
	EventThreadMembersUpdate Event = 71
	EventThreadUpdate Event = 72
	EventTypingStart Event = 73
	EventUserNoteUpdate Event = 74
	EventUserUpdate Event = 75
	EventVoiceServerUpdate Event = 76
	EventVoiceStateUpdate Event = 77
	EventWebhooksUpdate Event = 78
)
