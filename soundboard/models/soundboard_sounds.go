...
var SoundboardSoundTableColumns = struct {
	ID               string
	CreatedAt        string
	UpdatedAt        string
	GuildID          string
	...
	ID:               "soundboard_sounds.id",
	CreatedAt:        "soundboard_sounds.created_at",
	UpdatedAt:        "soundboard_sounds.updated_at",
	GuildID:          "soundboard_sounds.guild_id",
	RequiredRole:     "soundboard_sounds.required_role",
	Name:             "soundboard_sounds.name",
	Status:           "soundboard_sounds.status",
	RequiredRoles:    "soundboard_sounds.required_roles",
	BlacklistedRoles: "soundboard_sounds.blacklisted_roles",
}
...
var (
	...
	soundboardSoundColumnsWithoutDefault = []string{"created_at", "updated_at", "guild_id", "required_role", "name", "status"}
	soundboardSoundColumnsWithDefault    = []string{"id", "required_roles", "blacklisted_roles"}
	soundboardSoundPrimaryKeyColumns     = []string{"id"}
	soundboardSoundGeneratedColumns      = []string{}
)

type (
	// SoundboardSoundSlice is an alias for a slice of pointers to SoundboardSound.
	// This should almost always be used instead of []SoundboardSound.
...
// CountG returns the count of all SoundboardSound records in the query using the global executor
...
func SoundboardSounds(mods ...qm.QueryMod) soundboardSoundQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"soundboard_sounds\".*"})
	}

	return soundboardSoundQuery{q}
}
...
func (q soundboardSoundQuery) DeleteAllG(ctx context.Context) (int64, error) {
