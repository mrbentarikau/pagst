...
type CoreConfig struct {
	...
	ServerOwnerOnly         bool             `boil:"server_owner_only" json:"server_owner_only" toml:"server_owner_only" yaml:"server_owner_only"`
...
var CoreConfigColumns = struct {
	...
	ServerOwnerOnly:         "server_owner_only",
}
...
var CoreConfigTableColumns = struct {
	...
	ServerOwnerOnly:         "core_configs.server_owner_only",
}
...
var CoreConfigWhere = struct {
	...
	ServerOwnerOnly         whereHelperbool
}{
	...
	ServerOwnerOnly:         whereHelperbool{field: "\"core_configs\".\"server_owner_only\""},
}
...
var (
	coreConfigAllColumns            = []string{"guild_id", "allowed_read_only_roles", "allowed_write_roles", "allow_all_members_read_only", "allow_non_members_read_only", "server_owner_only"}
	coreConfigColumnsWithoutDefault = []string{"guild_id", "allow_all_members_read_only", "allow_non_members_read_only"}
	coreConfigColumnsWithDefault    = []string{"allowed_read_only_roles", "allowed_write_roles", "server_owner_only"}
	coreConfigPrimaryKeyColumns     = []string{"guild_id"}
	coreConfigGeneratedColumns      = []string{}
)

type (
	// CoreConfigSlice is an alias for a slice of pointers to CoreConfig.
	// This should almost always be used instead of []CoreConfig.
...
// CountG returns the count of all CoreConfig records in the query using the global executor
...
func CoreConfigs(mods ...qm.QueryMod) coreConfigQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"core_configs\".*"})
	}

	return coreConfigQuery{q}
}
