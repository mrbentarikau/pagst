...
var AutomodRuleDatumTableColumns = struct {
	ID       string
	GuildID  string
	RuleID   string
	Kind     string
	...
	ID:       "automod_rule_data.id",
	GuildID:  "automod_rule_data.guild_id",
	RuleID:   "automod_rule_data.rule_id",
	Kind:     "automod_rule_data.kind",
	TypeID:   "automod_rule_data.type_id",
	Settings: "automod_rule_data.settings",
}
...
func (r *automodRuleDatumR) GetRule() *AutomodRule {
	if r == nil {
		return nil
	}
	return r.Rule
...
func (r *automodRuleDatumR) GetTriggerAutomodTriggeredRules() AutomodTriggeredRuleSlice {
	if r == nil {
		return nil
	}
	return r.TriggerAutomodTriggeredRules
}
...
var (
	...
	automodRuleDatumGeneratedColumns      = []string{}
)

type (
	// AutomodRuleDatumSlice is an alias for a slice of pointers to AutomodRuleDatum.
	// This should almost always be used instead of []AutomodRuleDatum.
...
// CountG returns the count of all AutomodRuleDatum records in the query using the global executor
...
func AutomodRuleData(mods ...qm.QueryMod) automodRuleDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"automod_rule_data\".*"})
	}

	return automodRuleDatumQuery{q}
}
