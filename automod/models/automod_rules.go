...
var AutomodRuleTableColumns = struct {
	ID             string
	GuildID        string
	RulesetID      string
	Name           string
	...
	ID:             "automod_rules.id",
	GuildID:        "automod_rules.guild_id",
	RulesetID:      "automod_rules.ruleset_id",
	Name:           "automod_rules.name",
	TriggerCounter: "automod_rules.trigger_counter",
}
...
func (r *automodRuleR) GetRuleset() *AutomodRuleset {
	if r == nil {
		return nil
	}
	return r.Ruleset
...
func (r *automodRuleR) GetRuleAutomodRuleData() AutomodRuleDatumSlice {
	if r == nil {
		return nil
	}
	return r.RuleAutomodRuleData
}

func (r *automodRuleR) GetRuleAutomodTriggeredRules() AutomodTriggeredRuleSlice {
	if r == nil {
		return nil
	}
	return r.RuleAutomodTriggeredRules
}

func (r *automodRuleR) GetRuleAutomodViolations() AutomodViolationSlice {
	if r == nil {
		return nil
	}
	return r.RuleAutomodViolations
}
...
var (
	...
	automodRuleGeneratedColumns      = []string{}
)

type (
	// AutomodRuleSlice is an alias for a slice of pointers to AutomodRule.
	// This should almost always be used instead of []AutomodRule.
...
// CountG returns the count of all AutomodRule records in the query using the global executor
...
func (o *AutomodRule) RuleAutomodTriggeredRules(mods ...qm.QueryMod) automodTriggeredRuleQuery {
	...
	return AutomodTriggeredRules(queryMods...)
}
...
func (o *AutomodRule) RuleAutomodViolations(mods ...qm.QueryMod) automodViolationQuery {
	...
	return AutomodViolations(queryMods...)
}
...
func AutomodRules(mods ...qm.QueryMod) automodRuleQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"automod_rules\".*"})
	}

	return automodRuleQuery{q}
}
