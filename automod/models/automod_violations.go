...
var AutomodViolationTableColumns = struct {
	ID        string
	GuildID   string
	UserID    string
	RuleID    string
	...
	ID:        "automod_violations.id",
	GuildID:   "automod_violations.guild_id",
	UserID:    "automod_violations.user_id",
	RuleID:    "automod_violations.rule_id",
	CreatedAt: "automod_violations.created_at",
	Name:      "automod_violations.name",
}
...
func (r *automodViolationR) GetRule() *AutomodRule {
	if r == nil {
		return nil
	}
	return r.Rule
...
var (
	...
	automodViolationColumnsWithoutDefault = []string{"guild_id", "user_id", "created_at", "name"}
	automodViolationColumnsWithDefault    = []string{"id", "rule_id"}
	automodViolationPrimaryKeyColumns     = []string{"id"}
	automodViolationGeneratedColumns      = []string{}
)

type (
	// AutomodViolationSlice is an alias for a slice of pointers to AutomodViolation.
	// This should almost always be used instead of []AutomodViolation.
...
// CountG returns the count of all AutomodViolation records in the query using the global executor
...
func AutomodViolations(mods ...qm.QueryMod) automodViolationQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"automod_violations\".*"})
	}

	return automodViolationQuery{q}
}
