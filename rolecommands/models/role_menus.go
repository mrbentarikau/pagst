...
var RoleMenuTableColumns = struct {
	...
	MessageID:                     "role_menus.message_id",
	GuildID:                       "role_menus.guild_id",
	ChannelID:                     "role_menus.channel_id",
	OwnerID:                       "role_menus.owner_id",
	OwnMessage:                    "role_menus.own_message",
	State:                         "role_menus.state",
	NextRoleCommandID:             "role_menus.next_role_command_id",
	RoleGroupID:                   "role_menus.role_group_id",
	DisableSendDM:                 "role_menus.disable_send_dm",
	RemoveRoleOnReactionRemove:    "role_menus.remove_role_on_reaction_remove",
	FixedAmount:                   "role_menus.fixed_amount",
	SkipAmount:                    "role_menus.skip_amount",
	SetupMSGID:                    "role_menus.setup_msg_id",
	StandaloneMode:                "role_menus.standalone_mode",
	StandaloneMultipleMin:         "role_menus.standalone_multiple_min",
	StandaloneMultipleMax:         "role_menus.standalone_multiple_max",
	StandaloneSingleAutoToggleOff: "role_menus.standalone_single_auto_toggle_off",
	StandaloneSingleRequireOne:    "role_menus.standalone_single_require_one",
	StandaloneBlacklistRoles:      "role_menus.standalone_blacklist_roles",
	StandaloneWhitelistRoles:      "role_menus.standalone_whitelist_roles",
	SavedContent:                  "role_menus.saved_content",
	SavedEmbed:                    "role_menus.saved_embed",
	Kind:                          "role_menus.kind",
	EditingOptionID:               "role_menus.editing_option_id",
}
...
func (r *roleMenuR) GetEditingOption() *RoleMenuOption {
	if r == nil {
		return nil
	}
	return r.EditingOption
}

func (r *roleMenuR) GetNextRoleCommand() *RoleCommand {
	if r == nil {
		return nil
	}
	return r.NextRoleCommand
}

func (r *roleMenuR) GetRoleGroup() *RoleGroup {
	if r == nil {
		return nil
	}
	return r.RoleGroup
...
func (r *roleMenuR) GetRoleMenuOptions() RoleMenuOptionSlice {
	if r == nil {
		return nil
	}
	return r.RoleMenuOptions
}
...
var (
	...
	roleMenuColumnsWithoutDefault = []string{"message_id", "guild_id", "channel_id", "owner_id", "own_message", "state"}
	roleMenuColumnsWithDefault    = []string{"next_role_command_id", "role_group_id", "disable_send_dm", "remove_role_on_reaction_remove", "fixed_amount", "skip_amount", "setup_msg_id", "standalone_mode", "standalone_multiple_min", "standalone_multiple_max", "standalone_single_auto_toggle_off", "standalone_single_require_one", "standalone_blacklist_roles", "standalone_whitelist_roles", "saved_content", "saved_embed", "kind", "editing_option_id"}
...
func (o *RoleMenu) EditingOption(mods ...qm.QueryMod) roleMenuOptionQuery {
	...
	return RoleMenuOptions(queryMods...)
}
...
func RoleMenus(mods ...qm.QueryMod) roleMenuQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"role_menus\".*"})
	}
