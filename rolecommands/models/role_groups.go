...
var RoleGroupTableColumns = struct {
	ID                    string
	GuildID               string
	Name                  string
	RequireRoles          string
	...
	ID:                    "role_groups.id",
	GuildID:               "role_groups.guild_id",
	Name:                  "role_groups.name",
	RequireRoles:          "role_groups.require_roles",
	IgnoreRoles:           "role_groups.ignore_roles",
	Mode:                  "role_groups.mode",
	MultipleMax:           "role_groups.multiple_max",
	MultipleMin:           "role_groups.multiple_min",
	SingleAutoToggleOff:   "role_groups.single_auto_toggle_off",
	SingleRequireOne:      "role_groups.single_require_one",
	TemporaryRoleDuration: "role_groups.temporary_role_duration",
}
...
func (r *roleGroupR) GetRoleCommands() RoleCommandSlice {
	if r == nil {
		return nil
	}
	return r.RoleCommands
}

func (r *roleGroupR) GetRoleMenus() RoleMenuSlice {
	if r == nil {
		return nil
	}
	return r.RoleMenus
...
var (
	...
	roleGroupColumnsWithoutDefault = []string{"guild_id", "name", "mode", "multiple_max", "multiple_min", "single_auto_toggle_off", "single_require_one"}
	roleGroupColumnsWithDefault    = []string{"id", "require_roles", "ignore_roles", "temporary_role_duration"}
	roleGroupPrimaryKeyColumns     = []string{"id"}
	roleGroupGeneratedColumns      = []string{}
)

type (
	// RoleGroupSlice is an alias for a slice of pointers to RoleGroup.
	// This should almost always be used instead of []RoleGroup.
...
// CountG returns the count of all RoleGroup records in the query using the global executor
...
func RoleGroups(mods ...qm.QueryMod) roleGroupQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"role_groups\".*"})
	}

	return roleGroupQuery{q}
}
