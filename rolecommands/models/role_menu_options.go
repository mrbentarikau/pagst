...
var RoleMenuOptionTableColumns = struct {
	ID               string
	RoleCommandID    string
	EmojiID          string
	UnicodeEmoji     string
	...
	ID:               "role_menu_options.id",
	RoleCommandID:    "role_menu_options.role_command_id",
	EmojiID:          "role_menu_options.emoji_id",
	UnicodeEmoji:     "role_menu_options.unicode_emoji",
	RoleMenuID:       "role_menu_options.role_menu_id",
	StandaloneRoleID: "role_menu_options.standalone_role_id",
	BlacklistRoles:   "role_menu_options.blacklist_roles",
	WhitelistRoles:   "role_menu_options.whitelist_roles",
	EmojiAnimated:    "role_menu_options.emoji_animated",
}
...
func (r *roleMenuOptionR) GetRoleCommand() *RoleCommand {
	if r == nil {
		return nil
	}
...
func (r *roleMenuOptionR) GetRoleMenu() *RoleMenu {
	if r == nil {
		return nil
	}
	return r.RoleMenu
...
func (r *roleMenuOptionR) GetEditingOptionRoleMenus() RoleMenuSlice {
	if r == nil {
		return nil
	}
	return r.EditingOptionRoleMenus
}
...
var (
	...
	roleMenuOptionColumnsWithoutDefault = []string{"emoji_id", "unicode_emoji", "role_menu_id"}
	roleMenuOptionColumnsWithDefault    = []string{"id", "role_command_id", "standalone_role_id", "blacklist_roles", "whitelist_roles", "emoji_animated"}
	roleMenuOptionPrimaryKeyColumns     = []string{"id"}
	roleMenuOptionGeneratedColumns      = []string{}
)

type (
	// RoleMenuOptionSlice is an alias for a slice of pointers to RoleMenuOption.
	// This should almost always be used instead of []RoleMenuOption.
...
// CountG returns the count of all RoleMenuOption records in the query using the global executor
...
func RoleMenuOptions(mods ...qm.QueryMod) roleMenuOptionQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"role_menu_options\".*"})
	}

	return roleMenuOptionQuery{q}
}
