...
var RoleCommandTableColumns = struct {
	ID           string
	CreatedAt    string
	UpdatedAt    string
	GuildID      string
	...
	ID:           "role_commands.id",
	CreatedAt:    "role_commands.created_at",
	UpdatedAt:    "role_commands.updated_at",
	GuildID:      "role_commands.guild_id",
	Name:         "role_commands.name",
	RoleGroupID:  "role_commands.role_group_id",
	Role:         "role_commands.role",
	RequireRoles: "role_commands.require_roles",
	IgnoreRoles:  "role_commands.ignore_roles",
	Position:     "role_commands.position",
}
...
func (r *roleCommandR) GetRoleGroup() *RoleGroup {
	if r == nil {
		return nil
	}
	return r.RoleGroup
...
func (r *roleCommandR) GetRoleMenuOptions() RoleMenuOptionSlice {
	if r == nil {
		return nil
	}
...
func (r *roleCommandR) GetNextRoleCommandRoleMenus() RoleMenuSlice {
	if r == nil {
		return nil
	}
	return r.NextRoleCommandRoleMenus
}
...
var (
	...
	roleCommandColumnsWithoutDefault = []string{"created_at", "updated_at", "guild_id", "name", "role", "position"}
	roleCommandColumnsWithDefault    = []string{"id", "role_group_id", "require_roles", "ignore_roles"}
	roleCommandPrimaryKeyColumns     = []string{"id"}
	roleCommandGeneratedColumns      = []string{}
)

type (
	// RoleCommandSlice is an alias for a slice of pointers to RoleCommand.
	// This should almost always be used instead of []RoleCommand.
...
// CountG returns the count of all RoleCommand records in the query using the global executor
...
func RoleCommands(mods ...qm.QueryMod) roleCommandQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"role_commands\".*"})
	}

	return roleCommandQuery{q}
}
