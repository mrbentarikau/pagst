...
func (r *customCommandGroupR) GetGroupCustomCommands() CustomCommandSlice {
	if r == nil {
		return nil
	}
	return r.GroupCustomCommands
}
...
type (
	...
	// This should almost always be used instead of []CustomCommandGroup.
...
// CountG returns the count of all CustomCommandGroup records in the query using the global executor
...
func CustomCommandGroups(mods ...qm.QueryMod) customCommandGroupQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"custom_command_groups\".*"})
	}

	return customCommandGroupQuery{q}
}
