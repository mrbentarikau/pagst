...
var TemplatesUserDatabaseTableColumns = struct {
	ID        string
	CreatedAt string
	UpdatedAt string
	ExpiresAt string
	...
	ID:        "templates_user_database.id",
	CreatedAt: "templates_user_database.created_at",
	UpdatedAt: "templates_user_database.updated_at",
	ExpiresAt: "templates_user_database.expires_at",
	GuildID:   "templates_user_database.guild_id",
	UserID:    "templates_user_database.user_id",
	Key:       "templates_user_database.key",
	ValueNum:  "templates_user_database.value_num",
	ValueRaw:  "templates_user_database.value_raw",
}
...
var (
	...
	templatesUserDatabaseColumnsWithoutDefault = []string{"created_at", "updated_at", "guild_id", "user_id", "key", "value_num", "value_raw"}
	templatesUserDatabaseColumnsWithDefault    = []string{"id", "expires_at"}
	templatesUserDatabasePrimaryKeyColumns     = []string{"id"}
	templatesUserDatabaseGeneratedColumns      = []string{}
)

type (
	// TemplatesUserDatabaseSlice is an alias for a slice of pointers to TemplatesUserDatabase.
	// This should almost always be used instead of []TemplatesUserDatabase.
...
// CountG returns the count of all TemplatesUserDatabase records in the query using the global executor
...
func TemplatesUserDatabases(mods ...qm.QueryMod) templatesUserDatabaseQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"templates_user_database\".*"})
	}

	return templatesUserDatabaseQuery{q}
}
