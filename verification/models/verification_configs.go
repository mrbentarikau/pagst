...
var VerificationConfigTableColumns = struct {
	GuildID             string
	Enabled             string
	VerifiedRole        string
	PageContent         string
	...
	GuildID:             "verification_configs.guild_id",
	Enabled:             "verification_configs.enabled",
	VerifiedRole:        "verification_configs.verified_role",
	PageContent:         "verification_configs.page_content",
	KickUnverifiedAfter: "verification_configs.kick_unverified_after",
	WarnUnverifiedAfter: "verification_configs.warn_unverified_after",
	WarnMessage:         "verification_configs.warn_message",
	LogChannel:          "verification_configs.log_channel",
	DMMessage:           "verification_configs.dm_message",
}
...
var (
	...
	verificationConfigGeneratedColumns      = []string{}
)

type (
	// VerificationConfigSlice is an alias for a slice of pointers to VerificationConfig.
	// This should almost always be used instead of []VerificationConfig.
...
// CountG returns the count of all VerificationConfig records in the query using the global executor
...
func VerificationConfigs(mods ...qm.QueryMod) verificationConfigQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"verification_configs\".*"})
	}

	return verificationConfigQuery{q}
}
